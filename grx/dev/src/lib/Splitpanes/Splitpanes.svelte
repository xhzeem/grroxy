...
<script lang="ts">
	...
	import { getDimensionName } from './internal/sizing.js';
	import {
		type Position,
	...
	import { forEachPartial, sumPartial } from './internal/array.js';
	import { calcComputedStyle } from './internal/styling.js';
...
<style>
	:global(.splitpanes--horizontal.splitpanes--dragging) {
		cursor: row-resize;
	}
	:global(.splitpanes--vertical.splitpanes--dragging) {
		cursor: col-resize;
	}
	...
	:global(.splitpanes.splitpanes--vertical) {
		flex-direction: row;
	}
	:global(.splitpanes.splitpanes--horizontal) {
		flex-direction: column;
	}
	:global(.splitpanes.splitpanes--dragging *) {
		user-select: none;
	}
	...
	:global(.splitpanes--freeze .splitpanes__pane) {
		transition: none;
	}
