<script lang="ts">
	...
	import { KEY } from '$lib/Splitpanes/Splitpanes.svelte';
	import type { ClientCallbacks, IPane, PaneInitFunction, SplitContext } from './splitpanes.js';
	import { gatheringKey } from './internal/GatheringRound.svelte';
	import { getDimensionName } from './internal/sizing';
	import { carefullCallbackSource } from './internal/functions';
