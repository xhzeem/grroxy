import {
  highlightingFor,
  language
} from "./chunk-GEZ3LWS6.js";
import {
  highlightTree
} from "./chunk-T4RULASR.js";
import {
  Decoration,
  EditorView,
  GutterMarker,
...
import {
  ...
  StateField,
  Text
} from "./chunk-DZZJYQEQ.js";
import "./chunk-DE5T7PH5.js";
import "./chunk-UXIASGQL.js";

// ../../../../cybernetic-ui/node_modules/@codemirror/merge/dist/index.js
...
var inserted = Decoration.mark({ tagName: "ins" });
var deleted = Decoration.mark({ tagName: "del" });
      ...
      if (posA < endA && posB < endB)
        for (; ; ) {
          ...
          if (relA < 0 || relA < relB) {
            ...
            let diff2 = lineA.top + offA - (lineB.top + offB);
            if (diff2 < -epsilon) {
              offA -= diff2;
...
var uncollapse = StateEffect.define({
...
var MergeView = class {
  ...
  */
  ...
  dispatch(tr, target) {
    if (tr.docChanged) {
      this.chunks = target == this.a ? Chunk.updateA(this.chunks, tr.newDoc, this.b.state.doc, tr.changes) : Chunk.updateB(this.chunks, this.a.state.doc, tr.newDoc, tr.changes);
...
function unifiedMergeView(config) {
  ...
  return [
    ...
    EditorState.transactionExtender.of((tr) => {
      ...
      let chunks = updateDoc ? Chunk.updateA(prev, updateDoc.value.doc, tr.newDoc, updateDoc.value.changes) : Chunk.updateB(prev, tr.startState.field(originalDoc), tr.newDoc, tr.changes);
...
//# sourceMappingURL=@codemirror_merge.js.map
